...
describe("SensingAbility", () => {
  ...
  describe("initialization", () => {
    ...
    it("should have correct description", () => {
      expect(sensingAbility.getDescription()).toBe("周囲のワールドやエンティティの情報を取得します");
    });
  ...
  describe("entity detection", () => {
    ...
    it("should find nearest entity with filter", () => {
      const nearestPlayer = sensingAbility.findNearestEntity(e => e.type === "player");
    ...
    it("should return null when no entities match filter", () => {
      const dragon = sensingAbility.findNearestEntity(e => e.name === "ender_dragon");
