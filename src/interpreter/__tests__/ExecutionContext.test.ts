...
describe("BotScript ExecutionContext", () => {
	...
	describe("Variable Management", () => {
		...
		test("should throw error for undefined variables", () => {
			expect(() => context.getVariable("undefined_var")).toThrow(
				"Undefined variable: undefined_var",
			);
			expect(() => context.setVariable("undefined_var", 123)).toThrow(
				"Undefined variable: undefined_var",
			);
		});
		...
		test("should handle readonly variables", () => {
			...
			expect(() => context.setVariable("readonly_var", "changed")).toThrow(
				"Cannot modify readonly variable: readonly_var",
			);
		});
	...
	describe("Built-in Variables", () => {
		...
		test("should prevent modification of readonly built-in variables", () => {
			expect(() => context.setVariable("bot_name", "Modified")).toThrow(
				"Cannot modify readonly variable: bot_name",
			);
			expect(() => context.setVariable("version", "2.0.0")).toThrow(
				"Cannot modify readonly variable: version",
			);
			expect(() => context.setVariable("pi", 3.14)).toThrow(
				"Cannot modify readonly variable: pi",
			);
		});
